...
sony_result_t sony_tunermodule_RFLevelCalc (sony_tunerdemod_t * pTunerDemod, int32_t * pRFLeveldB,
...
sony_result_t sony_tunermodule_RFLevelCompensation (sony_tunerdemod_t * pTunerDemod, int32_t * pRFLeveldB)
{
...
sony_result_t sony_tunermodule_RFLevelCompensation_sub (sony_tunerdemod_t * pTunerDemod, int32_t * pRFLeveldB)
{
    sony_result_t result = SONY_RESULT_OK;
                                            ...
                                            sony_tunermodule_RfLevelParam  *pRFLevelTable)
{
    ...
    uint8_t  i;
    uint32_t  tune_freq;
    int32_t  offset_x1000, param_diff, freq_diff;
