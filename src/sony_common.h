...
extern void SONY_SLEEP(unsigned long n);
#endif
...
extern void sony_trace_log_enter(const char* funcname, const char* filename, unsigned int linenum);
extern void sony_trace_log_return(sony_result_t result, const char* filename, unsigned int linenum);
...
/* <PORTING> This is only a sample of trace macro. Please modify is necessary. */
extern void sony_trace_io_log_enter(const char* funcname, const char* filename, unsigned int linenum);
extern void sony_trace_io_log_return(sony_result_t result, const char* filename, unsigned int linenum);
