                  ...
                  uint32_t size, uint8_t mode)
{
    ...
    SONY_TRACE_IO_ENTER("drvi2c_feusb_Read");

    SONY_ARG_UNUSED(mode);

    if(!pI2c) SONY_TRACE_IO_RETURN(SONY_RESULT_ERROR_ARG);

    pDrvI2c = (drvi2c_feusb_t*)(pI2c->user);
    if(!pDrvI2c) SONY_TRACE_IO_RETURN(SONY_RESULT_ERROR_ARG);
...
{
    drvi2c_feusb_t *pDrvI2c = NULL;
    SONY_TRACE_IO_ENTER("drvi2c_feusb_Write");
...
{
    drvi2c_feusb_t *pDrvI2c = NULL;
    SONY_TRACE_IO_ENTER("drvi2c_feusb_ReadGw");
...
{
    drvi2c_feusb_t *pDrvI2c = NULL;
    SONY_TRACE_IO_ENTER("drvi2c_feusb_WriteGw");
...
{
    drvi2c_feusb_t *pDrvI2c = NULL;
    SONY_TRACE_IO_ENTER("drvi2c_feusb_ReadRegister");
...
{
    SONY_TRACE_IO_ENTER("drvi2c_feusb_Initialize");
...
{
    SONY_TRACE_IO_ENTER("drvi2c_feusb_Finalize");
...
{
    SONY_TRACE_IO_ENTER("drvi2c_feusb_CreateI2c");
...
{
    SONY_TRACE_IO_ENTER("drvi2c_feusb_CreateI2cGw");
